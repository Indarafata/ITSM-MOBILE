...
class DeviceDetail extends StatelessWidget {
  ...
  final DeviceModel device = Get.arguments;
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ListView(children: [
                            FieldDetail('Name', device.links[0].href),
                            FieldDetail('Status', device.name),
                            FieldDetail('Location',
                                controllerLocation.dataLocation!.name),
                            FieldDetail('Comment', device.comment!),
                            FieldDetail('Networking - IP', device.name),
                            FieldDetail('Serial Number', device.name),
                            FieldDetail('Alternative Username!', device.name!),
                            FieldDetail('Type', device.name!),
                            FieldDetail('OS - name', device.name!),
                            FieldDetail('OS - version', device.name!),
                          ]),
                        ),
                        Container(
