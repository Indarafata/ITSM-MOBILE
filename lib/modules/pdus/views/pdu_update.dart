...
class UpdatePdu extends StatelessWidget {
//   @override
//   State<UpdatePdu> createState() => _HomepageState();
// }

// class _HomepageState extends State<UpdatePdu> {
      ...
      body:
        ...
        child: Column(
          ...
          children: [
            ...
            // ),
            GestureDetector(
              onTap: () => controller.updatePdu(pdu.id!),
              child: Container(
