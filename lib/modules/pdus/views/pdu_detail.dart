              ...
              children: [
                ...
                Expanded(
                  child: ListView(children: [
                    ...
                    FieldDetail(
                        'Model                            :', pdu.name!),
                    FieldDetail('Last inventory              :', pdu.name!),
                    FieldDetail('Networking - IP            :', pdu.name!),
                    FieldDetail('Serial Number              :', pdu.name!),
                    FieldDetail('Alternative Username! :', pdu.name!),
                    FieldDetail(
                        'Type                               :', pdu.name!),
                    FieldDetail('OS - name!                      :', pdu.name!),
                    FieldDetail('OS - version                   :', pdu.name!),
                  ]),
                ),
                Container(
