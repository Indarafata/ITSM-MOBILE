...
class RackDetail extends StatelessWidget {
  RackDetail({super.key});
  final homeController = Get.find<HomeController>();
  final RackModel rack = Get.arguments;
              ...
              children: [
                ...
                Expanded(
                  child: ListView(children: [
                    ...
                    FieldDetail(
                        'Model                            :', rack.name!),
                    FieldDetail('Last inventory              :', rack.name!),
                    FieldDetail('Networking - IP            :', rack.name!),
                    FieldDetail('Serial Number              :', rack.name!),
                    FieldDetail('Alternative Username! :', rack.name!),
                    FieldDetail(
                        'Type                               :', rack.name!),
                    FieldDetail(
                        'OS - name!                      :', rack.name!),
                    FieldDetail('OS - version                   :', rack.name!),
                  ]),
                ),
                Container(
