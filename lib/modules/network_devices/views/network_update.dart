...
class UpdateNetwork extends StatelessWidget {
  // @override
  // State<UpdateNetwork> createState() => _HomepageState();
// }

// class _HomepageState extends State<UpdateNetwork> {
  var name = TextEditingController();
  final controllerLocation = Get.find<LocationController>();
  final controller = Get.find<NetworkController>();
  NetworkModel network = Get.arguments;
      ...
      body:
        ...
        child: Column(
          ...
          children: [
            ...
            // ),
            GestureDetector(
              onTap: () => controller.updateNetwork(network.id!),
              child: Container(
