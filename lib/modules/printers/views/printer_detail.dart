...
class PrinterDetail extends StatelessWidget {
  PrinterDetail({super.key});
              ...
              children: [
                ...
                Expanded(
                  child: ListView(children: [
                    ...
                    FieldDetail(
                        'Model                            :', printer.name!),
                    FieldDetail('Last inventory              :', printer.name!),
                    FieldDetail('Networking - IP            :', printer.name!),
                    FieldDetail('Serial Number              :', printer.name!),
                    FieldDetail('Alternative Username! :', printer.name!),
                    FieldDetail(
                        'Type                               :', printer.name!),
                    FieldDetail(
                        'OS - name!                      :', printer.name!),
                    FieldDetail(
                        'OS - version                   :', printer.name!),
                  ]),
                ),
                Container(
