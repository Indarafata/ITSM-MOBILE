...
class UpdatePhone extends StatefulWidget {
  @override
  State<UpdatePhone> createState() => _HomepageState();
}

class _HomepageState extends State<UpdatePhone> {
  var name = TextEditingController();
  final controller = Get.find<PhoneController>();
  final controllerLocation = Get.find<LocationController>();
  PhoneModel phone = Get.arguments;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ),
              GestureDetector(
                onTap: () => controller.updatePhone(phone.id!),
                child: Container(
